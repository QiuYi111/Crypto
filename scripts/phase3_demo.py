#!/usr/bin/env python3
"""
Phase 3 Demo: Multi-market RL training with Mamba architecture
"""
...
from src.cryptorl.rl.training import Trainer
from src.cryptorl.data.fusion import DataFusionEngine
...
async def test_mamba_exploration():
    ...
    observation_space = 20  # Based on our environment features
    action_space = 1
...
async def test_multi_market_training():
    ...
    episode_rewards = []
    for episode in range(20):  # Quick test with 20 episodes
